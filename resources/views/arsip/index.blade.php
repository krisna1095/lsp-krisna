                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-1">
                                                    <button type="button" class="btn btn-sm btn-danger" id="myBtn"
                                                        data-toggle="modal" data-target="#exampleModal"
                                                        data-id="{{ $item->id }}" onclick="HapusArsip(this);">
                                                        Hapus
                                                    </button>
                                                    <div class="vr"></div>
                                                    <a class="btn btn-sm btn-warning" href="/arsip/{{ $item->dokumen }}"
                                                        download>Unduh</a>
                                                    <div class="vr"></div>
                                                    <a class="btn btn-sm btn-primary"
                                                        href="/arsip/show/{{ $item->id }}">Lihat >></a>
                                                </div>
                                            </td>
                                        </tr>
